...
class System{
    ...
    function init(){
        ...
        if (\Ip\ServiceLocator::getContent()->isManagementState()) {
            ...
            //TODOX enable ipAddJavascript(ipConfig()->coreModuleUrl('Assets/assets/js/jquery-tools/jquery.tools.ui.tooltip.js'),2);
            //TODOX enable ipAddJavascript(ipConfig()->coreModuleUrl('Assets/assets/js/jquery-tools/jquery.tools.ui.overlay.js'),2);
